...
class UnrealcvData(JointsDataset):
    ...
    def __init__(self, cfg, image_set, is_train, transform=None):
        ...
        anno_file = osp.join(self.root, 'unrealcv', 'annot',
                             'unrealcv_{}.pkl'.format(image_set)) #image_set here should be 'train' or 'validation'
    ...
    def __getitem__(self, idx):  #魔法方法，用于添加特殊功能的函数，定义此函数后，可直接对用当前类生成的实例进行getitem(a)操作
