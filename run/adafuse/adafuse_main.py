...
def main():
    ...
    if run_phase == 'train':
        #eval('dataset.' + config.DATASET.TRAIN_DATASET) = dataset.unrealcv if config.DATASET.TRAIN_DATASET = unrealcv in the config file
        #We have import dataset at the top of this py file. So we can go to lib/dataset/__init__.py and see 
